     ...
     &    ifxxall(tailall+1),itype(tailall)
...
c
     ...
     &         newindx2,line29
         ...
         if (ifxpresent.gt.0) then
            read(2,'(i6,2x,A,f10.6,2x,f10.6,2x,f10.6,2x,i4,A)')nume,
     &          line5,x,y,z,indx2,line29
            write(3,'(i6,2x,A,f10.6,2x,f10.6,2x,f10.6,2x,i4,A)')nume,
     &         line5,x,y,z,ifixnewindx2,line29
