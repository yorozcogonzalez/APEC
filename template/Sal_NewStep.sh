...
cp $templatedir/DynIt.sh .
echo " Hydrogen atoms were minimized, then:"
echo " - if you chose no annealing, run DynIt.sh to perform further MD refinement"
echo " - if you are running the annealing, wait for the calculation to be finished, then run DynIt.sh"
echo ""
echo " NewStep.sh 0 OK" >> arm.err
